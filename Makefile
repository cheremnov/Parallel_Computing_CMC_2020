...
tests\test_Vector.cpp tsk1_solver.cpp
	g++ $(CFLAGS) -o tsk1 tsk1_graph_prepare.cpp tsk1_vector.cpp\
    tests\test_Vector.cpp tsk1_solver.cpp tsk1_real.cpp $(LLIB)
...
tests\test_Vector.cpp tsk1_solver.cpp
    ...
    tsk1_graph_prepare.cpp tsk1_vector.cpp tests\test_Vector.cpp tsk1_solver.cpp tsk1_real.cpp $(LLIB)
